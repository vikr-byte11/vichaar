...
<div class="col-lg-12 results">
       ...
       <div style="margin-left:350px"> <?php include('./font-p.php'); ?> </div>
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-success" id="color-picker1">
				<div class="card-header">
					<h3 class="card-title"><b>Survey Details</b></h3>
					<div style="float:right;">
				     <input type="color" id="color_palette1">
				  </div>
				</div>
		...
		<div class="col-md-8">
			<div class="card card-outline card-success" id="color-picker2">
				<div class="card-header">
					<h3 class="card-title"><b>Survey Questionaire</b></h3>
					<div style="float:right;">
				      <input type="color" id="color_palette2">
				   </div>
				</div>
				...
				<div class="card-footer border-top border-success">
					<div class="d-flex w-100 justify-content-center">
						<button class="btn btn-sm btn-flat mx-1" form="manage-survey" style="background-color:#1fab89; color:white">Submit Answer</button>
...
<script src="assets/dist/js/pages/colorPalette1.js"></script>
<script src="assets/dist/js/pages/colorPalette2.js"></script>
