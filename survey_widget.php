               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="index.php?page=answer_survey&id=<?php echo $row['id'] ?>" class="btn btn-secondary " > Take Survey</a>
               		<?php else: ?>
						<a href="" class="btn btn-secondary " > <i class="fas fa-check"> Submitted </i></a>
               		<?php endif; ?>
               	</div>
               </div>
              </div>
